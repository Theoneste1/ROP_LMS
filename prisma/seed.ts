...
- Symmetric polynomials`,
  ...
  if (students.length > 0 && lesson1_1) {
  ...
  console.log('\n📋 Test Credentials:')
  console.log('Admin: admin@rolms.rw / admin123')
  console.log('Instructor: instructor1@rolms.rw / instructor123')
  console.log('Student: student1@rolms.rw / student123')
}
